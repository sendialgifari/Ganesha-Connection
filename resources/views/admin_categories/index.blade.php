...
<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-splade-table :for="$admin_categories" pagination-scroll="preserve" striped>
                @cell('action', $admin_category)
                    <x-splade-link href="{{ route('admin_categories.edit', $admin_category) }}">
                        <x-splade-button
