...
<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-splade-form class="space-y-4" action="{{ route('donations.update', $donation) }}" method="put"
                :default="$donation">
                <x-splade-select name="donation_category_id" label="Kategori produk" :options="$donation_categories" />
