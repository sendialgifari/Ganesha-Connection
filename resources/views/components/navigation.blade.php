    ...
    <nav class="bg-white border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        ...
                        {{-- <x-application-mark class="block h-9 w-auto" /> --}}
                        <img src="{{ asset('images/logo-ganect.png') }}" class="h-8" alt="Ganesha Connection" />
                        </Link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        @endrole
                        @role('user')
                            <x-nav-link :href="route('partner_registration')" :active="request()->routeIs('partner_registration')">
                                {{ __('Daftar Partner') }}
                            </x-nav-link>
                        @endrole
                    </div>
        ...
        <div :class="{ 'block': mobileNavigation.open, 'hidden': !mobileNavigation.open }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                @endrole
                @role('user')
                    <x-responsive-nav-link :href="route('partner_registration')" :active="request()->routeIs('partner_registration')">
                        {{ __('Daftar Partner') }}
                    </x-responsive-nav-link>
                @endrole
            </div>
